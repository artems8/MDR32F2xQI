...
typedef enum
{
    ADC1_FLAG_OVERWRITE         = (((uint32_t)0x1) << ADC1_STATUS_FLG_REG_OVERWRITE_Pos),        /*!< The previous ADC1 measured value was overwritten. */
    ADC1_FLAG_OUT_OF_RANGE      = (((uint32_t)0x1) << ADC1_STATUS_FLG_REG_AWOIFEN_Pos),     /*!< The ADC1 measured value is out of range. */
    ADC1_FLAG_END_OF_CONVERSION = (((uint32_t)0x1) << ADC1_STATUS_FLG_REG_EOCIF_Pos) /*!< The ADC1 conversion finished. */
} ADC1_Flags;
...
typedef enum
{
    ADC1_IT_OUT_OF_RANGE      = (((uint32_t)0x1) << ADC1_STATUS_FLG_REG_AWOIFEN_Pos),
    ADC1_IT_END_OF_CONVERSION = (((uint32_t)0x1) << ADC1_STATUS_FLG_REG_EOCIF_Pos)
} ADC1_IT_Def;

#define IS_ADC_CONFIG_IT(IT)    (((IT) & (ADC1_IT_OUT_OF_RANGE | ADC1_IT_OUT_OF_RANGE)) == IT)
...
typedef struct
{
    ...
    uint32_t                   ADC_IntVRefTrimming;      /*!< Configures the internal voltage reference trimming.
                                                              This parameter can be a value of @ref ADC_Int_VRef_Trimming
...
typedef struct
{
    ADCx_Clock_Source      ADC_ClockSource;      /*!< Specifies the ADC1 clock source.
                                                      This parameter can be a value of @ref ADCx_Clock_Source */
    ADCx_Sampling_Mode     ADC_SamplingMode;     /*!< Specifies the ADC1 sampling mode.
                                                      This parameter can be a value of @ref ADCx_Sampling_Mode */
    ADCx_Channel_Switching ADC_ChannelSwitching; /*!< Enables or disables the ADC1 channel switching.
                                                      This parameter can be a value of @ref ADCx_Channel_Switching */
    ADCx_Channel_Number    ADC_ChannelNumber;    /*!< Specifies the ADC1 channel number.
    ...
    ADCx_Level_Control     ADC_LevelControl;     /*!< Enables or disables the ADC1 level control.
    ...
    uint16_t               ADC_HighLevel;        /*!< Specifies the ADC1 value high level.
                                                      This parameter can be a number between 0x0000 and 0x0FFF. */
    ADCx_VRef_Source       ADC_VRefSource;       /*!< Specifies the ADC1 voltage reference source (internal or external).
                                                      This parameter can be a value of @ref ADCx_VRef_Source */
    ADCx_Int_VRef_Source   ADC_IntVRefSource;    /*!< Specifies the ADC1 internal voltage reference source (inexact or exact).
                                                      This parameter can be a value of @ref ADCx_Int_VRef_Source */
    ADCx_Prescaler         ADC_Prescaler;        /*!< Specifies the ADC1 Prescaler configuration.
