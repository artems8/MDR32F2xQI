...
/** @addtogroup MDR32F21QI_Peripheral MDR32F21QI Peripheral
  * @{
  */
...
/* ===========================================  MDR1986VK214 Specific Interrupt Numbers  ========================================= */
  ...
  Reserved_9_IRQn           = 9,                /*!< Reserved  Interrupt  */
  ...
  ADCUI_F1_IRQn             = 15,               /*!< ADCIU_F0 Interrupt   */
  ADCUI_F2_IRQn             = 16,               /*!< ADCIU_F0 Interrupt   */
} IRQn_Type;

/** @addtogroup __MDR32F21QI___Configuration_of_CMSIS Configuration of CMSIS
  * @{
  */
...
/** @defgroup __MDR32F21QI___Exported_types Exported types
  * @{
  */
...
/** @addtogroup MDR32F21QI_Peripheral_Units MDR32F21QI Peripheral Units
  * @{
  */

/** @defgroup MDR32F21QI_Periph_SSP SSP
  * @{
  */
...
/** @defgroup MDR32F21QI_Periph_UART UART
  * @{
  */
...
/** @defgroup MDR32F21QI_Periph_EEPROM EEPROM
  * @{
  */
...
/** @defgroup MDR32F21QI_Periph_RST_CLK RST_CLK
  * @{
  */
...
/** @defgroup MDR32F21QI_Periph_ADC ADC
  * @{
  */
...
/** @defgroup MDR32F21QI_Periph_WWDG WWDG
  * @{
  */
...
/** @defgroup MDR32F21QI_Periph_IWDG IWDG
  * @{
  */
...
/** @defgroup MDR32F21QI_Periph_POWER POWER
  * @{
  */
...
/** @defgroup MDR32F21QI_Periph_BKP BKP
  * @{
  */
...
/** @defgroup MDR32F21QI_Periph_ADCIU ADCIU
  * @{
  */
...
typedef struct {
    ...
    __IO uint32_t   F1CTR;             /*!< Conrtol in channel F1*/
    __IO uint32_t   F1WC;              /*!< Active power calculation control in channel F1*/
    __IO uint32_t   F1WATTP;           /*!< Positive active power value in channel F1*/
    __IO uint32_t   F1WATTN;           /*!< Negative active power value in channel F1*/
    __IO uint32_t   F1VC;              /*!< Reactive power calculation control in channel F1*/
    __IO uint32_t   F1VARP;            /*!< Positive reactive power value in channel F1*/
    __IO uint32_t   F1VARN;            /*!< Negative reactive power value in channel F1*/
    __IO uint32_t   F1AC;              /*!< Apparent power calculation control in channel F1*/
    __IO uint32_t   F1VR;              /*!< Apparent power value in channel F1*/
    __IO uint32_t   F1MD0;             /*!< Parameters 0 channel F1*/
    __IO uint32_t   F1MD1;             /*!< Parameters 1 channel F1*/
    __IO uint32_t   F1VPEAK;           /*!< Peak value in the voltage channel in channel F1*/
    __IO uint32_t   F1IPEAK;           /*!< Peak value in current channel in channel F1*/
    __IO uint32_t   F1VDAT;            /*!< Voltage readings in channel F1*/
    __IO uint32_t   F1I0DAT;           /*!< Current readings I0 in channel F1*/
    __IO uint32_t   F1I3DAT;           /*!< Current readings I3 in channel F1*/
    __IO uint32_t   F1VRMS;            /*!< RMS value channel voltage F1*/
    __IO uint32_t   F1VRMS2;           /*!< RMS squared in F1 voltage channel*/
    __IO uint32_t   F1IRMS;            /*!< RMS current channel F1*/
    __IO uint32_t   F1IRMS2;           /*!< RMS squared in current channel F1*/
    __IO uint32_t   F1STAT;            /*!< Channel status F1*/
    __IO uint32_t   F1MASK;            /*!< F1 channel interrupt mask*/
    __IO uint32_t   F2CTR;             /*!< Conrtol in channel F2*/
    __IO uint32_t   F2WC;              /*!< Active power calculation control in channel F2*/
    __IO uint32_t   F2WATTP;           /*!< Positive active power value in channel F2*/
    __IO uint32_t   F2WATTN;           /*!< Negative active power value in channel F2*/
    __IO uint32_t   F2VC;              /*!< Reactive power calculation control in channel F2*/
    __IO uint32_t   F2VARP;            /*!< Positive reactive power value in channel F2*/
    __IO uint32_t   F2VARN;            /*!< Negative reactive power value in channel F2*/
    __IO uint32_t   F2AC;              /*!< Apparent power calculation control in channel F2*/
    __IO uint32_t   F2VR;              /*!< Apparent power value in channel F2*/
    __IO uint32_t   F2MD0;             /*!< Parameters 0 channel F2*/
    __IO uint32_t   F2MD1;             /*!< Parameters 1 channel F2*/
    __IO uint32_t   F2VPEAK;           /*!< Peak value in the voltage channel in channel F2*/
    __IO uint32_t   F2IPEAK;           /*!< Peak value in current channel in channel F2*/
    __IO uint32_t   F2VDAT;            /*!< Voltage readings in channel F2*/
    __IO uint32_t   F2I0DAT;           /*!< Current readings I0 in channel F2*/
    __IO uint32_t   F2I3DAT;           /*!< Current readings I3 in channel F2*/
    __IO uint32_t   F2VRMS;            /*!< RMS value channel voltage F2*/
    __IO uint32_t   F2VRMS2;           /*!< RMS squared in F2 voltage channel*/
    __IO uint32_t   F2IRMS;            /*!< RMS current channel F2*/
    __IO uint32_t   F2IRMS2;           /*!< RMS squared in current channel F2*/
    __IO uint32_t   F2STAT;            /*!< Channel status F2*/
    __IO uint32_t   F2MASK;            /*!< F2 channel interrupt mask*/
    __IO uint32_t   CCAL1;             /*!< Current Channel Calibration Register 1*/
    __IO uint32_t   CCAL2;             /*!< Current Channel Calibration Register 2*/
    __IO uint32_t   CCAL3;             /*!< Current Channel Calibration Register 3*/
...
/** @defgroup Periph_ADCIU_FxCTR ADCIU FxCTR 
  * @{
  */

/*-- ADCIU_FxCTR:ADCIU FxCTR Register -----*/

/* Bit field positions: */
#define ADCIU_FxCTR_FxI0NTEN_Pos                           0
#define ADCIU_FxCTR_FxI3NTEN_Pos                           1
#define ADCIU_FxCTR_FxVASEL_Pos                            2
#define ADCIU_FxCTR_FxRARS_Pos                             3
#define ADCIU_FxCTR_FxRRRS_Pos                             4
#define ADCIU_FxCTR_FxRVRS_Pos                             5
#define ADCIU_FxCTR_FxI0GAIN_Pos                           6
#define ADCIU_FxCTR_FxVGAIN_Pos                            8
#define ADCIU_FxCTR_FxVPHASE_Pos                           10
#define ADCIU_FxCTR_FxI3GAIN_Pos                           18
#define ADCIU_FxCTR_FxIRMSOS_Pos                           20

/* Bit field masks: */
#define ADCIU_FxCTR_FxI0NTEN_Msk                          ((uint32_t)0x00000001)
#define ADCIU_FxCTR_FxI3NTEN_Msk                          ((uint32_t)0x00000002)
#define ADCIU_FxCTR_FxVASEL_Msk                           ((uint32_t)0x00000004)
#define ADCIU_FxCTR_FxRARS_Msk                            ((uint32_t)0x00000008)
#define ADCIU_FxCTR_FxRRRS_Msk                            ((uint32_t)0x00000010)
#define ADCIU_FxCTR_FxRVRS_Msk                            ((uint32_t)0x00000020)
#define ADCIU_FxCTR_FxI0GAIN_Msk                          ((uint32_t)0x000000C0)
#define ADCIU_FxCTR_FxVGAIN_Msk                           ((uint32_t)0x00000300)
#define ADCIU_FxCTR_FxVPHASE_Msk                          ((uint32_t)0x0003FC00)
#define ADCIU_FxCTR_FxI3GAIN_Msk                          ((uint32_t)0x000C0000)
#define ADCIU_FxCTR_FxIRMSOS_Msk                          ((uint32_t)0xFFF00040)

/** @} */ /* End of group ADCIU_FxCTR */

/** @defgroup Periph_ADCIU_FxWС ADCIU FxWС
  * @{
  */

/*-- ADCIU_FxWС:ADCIU FxWС Register -----*/

/* Bit field positions: */
#define ADCIU_FxWС_FxWATTOS_Pos                           0
#define ADCIU_FxWС_FxWGAIN_Pos                            16

/* Bit field masks: */
#define ADCIU_FxWС_FxWATTOS_Msk                          ((uint32_t)0x0000FFFF)
#define ADCIU_FxWС_FxWGAIN_Msk                           ((uint32_t)0x0FFF0000)

/** @} */ /* End of group ADCIU_FxWС */

/** @defgroup Periph_ADCIU_FxWATTP ADCIU FxWATTP
  * @{
  */

/*-- ADCIU_FxWATTP:ADCIU FxWATTP Register -----*/

/* Bit field positions: */
#define ADCIU_FxWATTP_FxWATTHRP_Pos                      0

/* Bit field masks: */
#define ADCIU_FxWATTP_FxWATTHRP_Msk                      ((uint32_t)0xFFFFFFFF)

/** @} */ /* End of group ADCIU_FxWATTP */

/** @defgroup Periph_ADCIU_FxWATTN ADCIU FxWATTN
  * @{
  */

/*-- ADCIU_FxWATTN:ADCIU FxWATTN Register -----*/

/* Bit field positions: */
#define ADCIU_FxWATTN_FxWATTHRN_Pos                      0

/* Bit field masks: */
#define ADCIU_FxWATTN_FxWATTHRN_Msk                     ((uint32_t)0xFFFFFFFF)

/** @} */ /* End of group ADCIU_FxWATTN */

/** @defgroup Periph_ADCIU_FxVС ADCIU FxVС
  * @{
  */

/*-- ADCIU_FxVС:ADCIU FxVС Register -----*/

/* Bit field positions: */
#define ADCIU_FxVС_FxVAROS_Pos                            0
#define ADCIU_FxVС_FxVARGAIN_Pos                          16

/* Bit field masks: */
#define ADCIU_FxVС_FxVAROS_Msk                           ((uint32_t)0x0000FFFF)
#define ADCIU_FxVС_FxVARGAIN_Msk                           ((uint32_t)0x0FFF0000)

/** @} */ /* End of group ADCIU_FxVС */

/** @defgroup Periph_ADCIU_FxVARP ADCIU FxVARP
  * @{
  */

/*-- ADCIU_FxVARP:ADCIU FxVARP Register -----*/

/* Bit field positions: */
#define ADCIU_FxVARP_FxVARHRP_Pos                         0

/* Bit field masks: */
#define ADCIU_FxVARP_FxVARHRP_Msk                         ((uint32_t)0xFFFFFFFF)

/** @} */ /* End of group ADCIU_FxVARP */

/** @defgroup Periph_ADCIU_FxVARN ADCIU FxVARN
  * @{
  */

/*-- ADCIU_FxVARN:ADCIU FxVARN Register -----*/

/* Bit field positions: */
#define ADCIU_FxVARN_FxVARHRN_Pos                        0

/* Bit field masks: */
#define ADCIU_FxVARN_FxVARHRN_Msk                        ((uint32_t)0xFFFFFFFF)

/** @} */ /* End of group ADCIU_FxVARN */

/** @defgroup Periph_ADCIU_FxAС ADCIU FxAС
  * @{
  */

/*-- ADCIU_FxAС:ADCIU FxAС Register -----*/

/* Bit field positions: */
#define ADCIU_FxAС_FxVRMSOS_Pos                         0
#define ADCIU_FxAС_FxVAGAIN_Pos                         16

/* Bit field masks: */
#define ADCIU_FxAС_FxVRMSOS_Msk                         ((uint32_t)0x00000FFF)
#define ADCIU_FxAС_FxVAGAIN_Msk                         ((uint32_t)0x0FFF0000)

/** @} */ /* End of group ADCIU_FxAС */

/** @defgroup Periph_ADCIU_FxVR ADCIU FxVR
  * @{
  */

/*-- ADCIU_FxVR:ADCIU FxVR Register -----*/

/* Bit field positions: */
#define ADCIU_FxVR_FxVAHR_Pos                        0

/* Bit field masks: */
#define ADCIU_FxVR_FxVAHR_Msk                        ((uint32_t)0xFFFFFFFF)

/** @} */ /* End of group ADCIU_FxVR */

/** @defgroup Periph_ADCIU_FxMD0 ADCIU FxMD0
  * @{
  */

/*-- ADCIU_FxMD0:ADCIU FxMD0 Register -----*/

/* Bit field positions: */
#define ADCIU_FxMD0_FxVSEL_Pos                        0
#define ADCIU_FxMD0_FxISEL_Pos                        2
#define ADCIU_FxMD0_FxACTS_Pos                        4
#define ADCIU_FxMD0_FxREACTS_Pos                      5
#define ADCIU_FxMD0_I0GAIN_Pos                        6
#define ADCIU_FxMD0_V0GAIN_Pos                        7
#define ADCIU_FxMD0_I3GAIN_Pos                        8
#define ADCIU_FxMD0_FxPER_FREQ_Pos                    12
#define ADCIU_FxMD0_FxI3SEL_Pos                       29
#define ADCIU_FxMD0_FxSEL_I_CH_Pos                    30

/* Bit field masks: */
#define ADCIU_FxMD0_FxVSEL_Msk                        ((uint32_t)0x00000003)
#define ADCIU_FxMD0_FxISEL_Msk                        ((uint32_t)0x0000000C)
#define ADCIU_FxMD0_FxACTS_Msk                        ((uint32_t)0x00000010)
#define ADCIU_FxMD0_FxREACTS_Msk                      ((uint32_t)0x00000020)
#define ADCIU_FxMD0_I0GAIN_Msk                        ((uint32_t)0x00000040)
#define ADCIU_FxMD0_V0GAIN_Msk                        ((uint32_t)0x00000080)
#define ADCIU_FxMD0_I3GAIN_Msk                        ((uint32_t)0x00000100)
#define ADCIU_FxMD0_FxPER_FREQ_Msk                    ((uint32_t)0x1FFFF000)
#define ADCIU_FxMD0_FxI3SEL_Msk                       ((uint32_t)0x20000000)
#define ADCIU_FxMD0_FxSEL_I_CH_Msk                       ((uint32_t)0xC0000000)

/** @} */ /* End of group ADCIU_FxMD0 */

/** @defgroup Periph_ADCIU_FxMD1 ADCIU FxMD1
  * @{
  */

/*-- ADCIU_FxMD1:ADCIU FxMD1 Register -----*/

/* Bit field positions: */
#define ADCIU_FxMD1_FxIPKLVL_Pos                        0
#define ADCIU_FxMD1_FxVPKLVL_Pos                        16

/* Bit field masks: */
#define ADCIU_FxMD1_FxIPKLVL_Msk                        ((uint32_t)0x0000FFFF)
#define ADCIU_FxMD1_FxVPKLVL_Msk                        ((uint32_t)0xFFFF0000)

/** @} */ /* End of group ADCIU_FxMD1 */

/** @defgroup Periph_ADCIU_FxVPEAK ADCIU FxVPEAK
  * @{
  */

/*-- ADCIU_FxVPEAK:ADCIU FxVPEAK Register -----*/

/* Bit field positions: */
#define ADCIU_FxVPEAK_FxVPEAK_Pos                        0

/* Bit field masks: */
#define ADCIU_FxVPEAK_FxVPEAK_Msk                        ((uint32_t)0x00FFFFFF)

/** @} */ /* End of group FxVPEAK */


/** @defgroup Periph_ADCIU_FxIPEAK ADCIU FxIPEAK
  * @{
  */

/*-- ADCIU_FxIPEAK:ADCIU FxIPEAK Register -----*/

/* Bit field positions: */
#define ADCIU_FxIPEAK_FxIPEAK_Pos                        0

/* Bit field masks: */
#define ADCIU_FxIPEAK_FxIPEAK_Msk                        ((uint32_t)0x00FFFFFF)

/** @} */ /* End of group FxIPEAK */


/** @defgroup Periph_ADCIU_FxVDAT ADCIU FxVDAT
  * @{
  */

/*-- ADCIU_FxVDAT:ADCIU FxVDAT Register -----*/

/* Bit field positions: */
#define ADCIU_FxVDAT_FxVDAT_Pos                        0

/* Bit field masks: */
#define ADCIU_FxVDAT_FxVDAT_Msk                        ((uint32_t)0x00FFFFFF)

/** @} */ /* End of group FxVDAT */

/** @defgroup Periph_ADCIU_FxI0DAT ADCIU FxI0DAT
  * @{
  */

/*-- ADCIU_FxI0DAT:ADCIU FxI0DAT Register -----*/

/* Bit field positions: */
#define ADCIU_FxI0DAT_FxI0DAT_Pos                        0

/* Bit field masks: */
#define ADCIU_FxI0DAT_FxI0DAT_Msk                        ((uint32_t)0x00FFFFFF)

/** @} */ /* End of group FxI0DAT */

/** @defgroup Periph_ADCIU_FxI3DAT ADCIU FxI3DAT
  * @{
  */

/*-- ADCIU_FxI3DAT:ADCIU FxI3DAT Register -----*/

/* Bit field positions: */
#define ADCIU_FxI3DAT_FxI3DAT_Pos                        0

/* Bit field masks: */
#define ADCIU_FxI3DAT_FxI3DAT_Msk                        ((uint32_t)0x00FFFFFF)

/** @} */ /* End of group FxI3DAT */

/** @defgroup Periph_ADCIU_FxVRMS ADCIU FxVRMS
  * @{
  */

/*-- ADCIU_FxVRMS:ADCIU FxVRMS Register -----*/

/* Bit field positions: */
#define ADCIU_FxVRMS_FxVRMS_Pos                        0

/* Bit field masks: */
#define ADCIU_FxVRMS_FxVRMS_Msk                        ((uint32_t)0x00FFFFFF)

/** @} */ /* End of group FxVRMS */

/** @defgroup Periph_ADCIU_FxVRMS2 ADCIU FxVRMS2
  * @{
  */

/*-- ADCIU_FxVRMS2:ADCIU FxVRMS Register -----*/

/* Bit field positions: */
#define ADCIU_FxVRMS2_FxVRMS2_Pos                        0

/* Bit field masks: */
#define ADCIU_FxVRMS2_FxVRMS2_Msk                        ((uint32_t)0xFFFFFFFF)

/** @} */ /* End of group FxVRMS2 */

/** @defgroup Periph_ADCIU_FxIRMS ADCIU FxIRMS
  * @{
  */

/*-- ADCIU_FxIRMS:ADCIU FxIRMS Register -----*/

/* Bit field positions: */
#define ADCIU_FxIRMS_FxIRMS_Pos                        0

/* Bit field masks: */
#define ADCIU_FxIRMS_FxIRMS_Msk                        ((uint32_t)0x00FFFFFF)

/** @} */ /* End of group FxIRMS */

/** @defgroup Periph_ADCIU_FxIRMS2 ADCIU FxIRMS2
  * @{
  */

/*-- ADCIU_FxIRMS2:ADCIU FxIRMS2 Register -----*/

/* Bit field positions: */
#define ADCIU_FxIRMS2_FxIRMS2_Pos                        0

/* Bit field masks: */
#define ADCIU_FxIRMS2_FxIRMS2_Msk                        ((uint32_t)0xFFFFFFFF)

/** @} */ /* End of group FxIRMS2 */

/** @defgroup Periph_ADCIU_FxSTAT ADCIU FxSTAT
  * @{
  */

/*-- ADCIU_FxSTAT:ADCIU FxSTAT Register -----*/

/* Bit field positions: */
#define ADCIU_FxSTAT_FxVF_EMP_Pos                        0
#define ADCIU_FxSTAT_FxVF_FLL_Pos                        1
#define ADCIU_FxSTAT_FxVF_OVR_Pos                        2
#define ADCIU_FxSTAT_FxIF_EMP_Pos                        3
#define ADCIU_FxSTAT_FxIF_FLL_Pos                        4
#define ADCIU_FxSTAT_FxIF_OVR_Pos                        5
#define ADCIU_FxSTAT_FxSAGF_Pos                          6
#define ADCIU_FxSTAT_FxPEAKVF_Pos                        7
#define ADCIU_FxSTAT_FxPEAKIF_Pos                        8
#define ADCIU_FxSTAT_FxWATTOVP_Pos                       9
#define ADCIU_FxSTAT_FxVAROVP_Pos                        10
#define ADCIU_FxSTAT_FxVAOV_Pos                          11
#define ADCIU_FxSTAT_FxZXTOF_Pos                         12
#define ADCIU_FxSTAT_FxICHANNEL_Pos                      13
#define ADCIU_FxSTAT_FxFAULTCON_Pos                      14
#define ADCIU_FxSTAT_FxAPSIGN_Pos                        15
#define ADCIU_FxSTAT_FxAPNLDFL_Pos                       16
#define ADCIU_FxSTAT_FxVARSIGN_Pos                       17
#define ADCIU_FxSTAT_FxVARNLDFL_Pos                      18
#define ADCIU_FxSTAT_FxVANLDFL_Pos                       20
#define ADCIU_FxSTAT_FxZEROCRS_Pos                       21
#define ADCIU_FxSTAT_C3IF_EMP_Pos                        22
#define ADCIU_FxSTAT_C3IF_FLL_Pos                        23
#define ADCIU_FxSTAT_C3IF_OVR_Pos                        24
#define ADCIU_FxSTAT_FxWATTOVN_Pos                       25
#define ADCIU_FxSTAT_FxVAROVN_Pos                        26

/* Bit field masks: */
#define ADCIU_FxSTAT_FxVF_EMP_Msk                       ((uint32_t)0x00000001)
#define ADCIU_FxSTAT_FxVF_FLL_Msk                       ((uint32_t)0x00000002)
#define ADCIU_FxSTAT_FxVF_OVR_Msk                       ((uint32_t)0x00000004)
#define ADCIU_FxSTAT_FxIF_EMP_Msk                       ((uint32_t)0x00000008)
#define ADCIU_FxSTAT_FxIF_FLL_Msk                       ((uint32_t)0x00000010)
#define ADCIU_FxSTAT_FxIF_OVR_Msk                       ((uint32_t)0x00000020)
#define ADCIU_FxSTAT_FxSAGF_Msk                         ((uint32_t)0x00000040)
#define ADCIU_FxSTAT_FxPEAKVF_Msk                       ((uint32_t)0x00000080)
#define ADCIU_FxSTAT_FxPEAKIF_Msk                       ((uint32_t)0x00000100)
#define ADCIU_FxSTAT_FxWATTOVP_Msk                      ((uint32_t)0x00000200)
#define ADCIU_FxSTAT_FxVAROVP_Msk                       ((uint32_t)0x00000400)
#define ADCIU_FxSTAT_FxVAOV_Msk                         ((uint32_t)0x00000800)
#define ADCIU_FxSTAT_FxZXTOF_Msk                        ((uint32_t)0x00001000)
#define ADCIU_FxSTAT_FxICHANNEL_Msk                     ((uint32_t)0x00002000)
#define ADCIU_FxSTAT_FxFAULTCON_Msk                     ((uint32_t)0x00004000)
#define ADCIU_FxSTAT_FxAPSIGN_Msk                       ((uint32_t)0x00008000)
#define ADCIU_FxSTAT_FxAPNLDFL_Msk                      ((uint32_t)0x00010000)
#define ADCIU_FxSTAT_FxVARSIGN_Msk                      ((uint32_t)0x00020000)
#define ADCIU_FxSTAT_FxVARNLDFL_Msk                     ((uint32_t)0x00040000)
#define ADCIU_FxSTAT_FxVANLDFL_Msk                      ((uint32_t)0x00100000)
#define ADCIU_FxSTAT_FxZEROCRS_Msk                      ((uint32_t)0x00200000)
#define ADCIU_FxSTAT_C3IF_EMP_Msk                       ((uint32_t)0x00400000)
#define ADCIU_FxSTAT_C3IF_FLL_Msk                       ((uint32_t)0x00800000)
#define ADCIU_FxSTAT_C3IF_OVR_Msk                       ((uint32_t)0x01000000)
#define ADCIU_FxSTAT_FxWATTOVN_Msk                      ((uint32_t)0x02000000)
#define ADCIU_FxSTAT_FxVAROVN_Msk                       ((uint32_t)0x04000000)

/** @} */ /* End of group ADCIU_FxSTAT */


/** @defgroup Periph_ADCIU_FxMASK ADCIU FxMASK
  * @{
  */

/*-- ADCIU_FxMASK:ADCIU FxMASK Register -----*/

/* Bit field positions: */
#define ADCIU_FxMASK_FxVF_EMPM_Pos                        0
#define ADCIU_FxMASK_FxVF_FLLM_Pos                        1
#define ADCIU_FxMASK_FxVF_OVRM_Pos                        2
#define ADCIU_FxMASK_FxIF_EMPM_Pos                        3
#define ADCIU_FxMASK_FxIF_FLLM_Pos                        4
#define ADCIU_FxMASK_FxIF_OVRM_Pos                        5
#define ADCIU_FxMASK_FxSAGFM_Pos                          6
#define ADCIU_FxMASK_FxPEAKVFM_Pos                        7
#define ADCIU_FxMASK_FxPEAKIFM_Pos                        8
#define ADCIU_FxMASK_FxWATTOVPM_Pos                       9
#define ADCIU_FxMASK_FxVAROVPM_Pos                        10
#define ADCIU_FxMASK_FxVAOVM_Pos                          11
#define ADCIU_FxMASK_FxZXTOFM_Pos                         12
#define ADCIU_FxMASK_FxFAULTCONM_Pos                      14
#define ADCIU_FxMASK_FxAPSIGNM_Pos                        15
#define ADCIU_FxMASK_FxAPNLDFLM_Pos                       16
#define ADCIU_FxMASK_FxVARSIGNM_Pos                       17
#define ADCIU_FxMASK_FxVARNLDFLM_Pos                      18
#define ADCIU_FxMASK_FxVANLDFLM_Pos                       20
#define ADCIU_FxMASK_FxZEROCRSM_Pos                       21
#define ADCIU_FxMASK_C3IF_EMPM_Pos                        22
#define ADCIU_FxMASK_C3IF_FLLM_Pos                        23
#define ADCIU_FxMASK_C3IF_OVRM_Pos                        24
#define ADCIU_FxMASK_FxWATTOVNM_Pos                       25
#define ADCIU_FxMASK_FxVAROVNM_Pos                        26

/* Bit field masks: */
#define ADCIU_FxMASK_FxVF_EMPM_Msk                       ((uint32_t)0x00000001)
#define ADCIU_FxMASK_FxVF_FLLM_Msk                       ((uint32_t)0x00000002)
#define ADCIU_FxMASK_FxVF_OVRM_Msk                       ((uint32_t)0x00000004)
#define ADCIU_FxMASK_FxIF_EMPM_Msk                       ((uint32_t)0x00000008)
#define ADCIU_FxMASK_FxIF_FLLM_Msk                       ((uint32_t)0x00000010)
#define ADCIU_FxMASK_FxIF_OVRM_Msk                       ((uint32_t)0x00000020)
#define ADCIU_FxMASK_FxSAGFM_Msk                         ((uint32_t)0x00000040)
#define ADCIU_FxMASK_FxPEAKVFM_Msk                       ((uint32_t)0x00000080)
#define ADCIU_FxMASK_FxPEAKIFM_Msk                       ((uint32_t)0x00000100)
#define ADCIU_FxMASK_FxWATTOVPM_Msk                      ((uint32_t)0x00000200)
#define ADCIU_FxMASK_FxVAROVPM_Msk                       ((uint32_t)0x00000400)
#define ADCIU_FxMASK_FxVAOVM_Msk                         ((uint32_t)0x00000800)
#define ADCIU_FxMASK_FxZXTOFM_Msk                        ((uint32_t)0x00001000)
#define ADCIU_FxMASK_FxFAULTCONM_Msk                     ((uint32_t)0x00004000)
#define ADCIU_FxMASK_FxAPSIGNM_Msk                       ((uint32_t)0x00008000)
#define ADCIU_FxMASK_FxAPNLDFLM_Msk                      ((uint32_t)0x00010000)
#define ADCIU_FxMASK_FxVARSIGNM_Msk                      ((uint32_t)0x00020000)
#define ADCIU_FxMASK_FxVARNLDFLM_Msk                     ((uint32_t)0x00040000)
#define ADCIU_FxMASK_FxVANLDFLM_Msk                      ((uint32_t)0x00100000)
#define ADCIU_FxMASK_FxZEROCRSM_Msk                      ((uint32_t)0x00200000)
#define ADCIU_FxMASK_C3IF_EMPM_Msk                       ((uint32_t)0x00400000)
#define ADCIU_FxMASK_C3IF_FLLM_Msk                       ((uint32_t)0x00800000)
#define ADCIU_FxMASK_C3IF_OVRM_Msk                       ((uint32_t)0x01000000)
#define ADCIU_FxMASK_FxWATTOVNM_Msk                      ((uint32_t)0x02000000)
#define ADCIU_FxMASK_FxVAROVNM_Msk                       ((uint32_t)0x04000000)

/** @} */ /* End of group ADCIU_FxMASK */
...
/** @defgroup MDR32F21QI_Periph_TIMER TIMER
  * @{
  */
...
/** @defgroup MDR32F21QI_Periph_PORT PORT
  * @{
  */
...
/** @defgroup MDR32F21QI_Periph_CRC CRC
  * @{
  */
...
/** @} */ /* End of group __MDR32F21QI_Peripheral */
