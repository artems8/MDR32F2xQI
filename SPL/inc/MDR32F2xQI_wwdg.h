...
typedef enum
{
    WWDG_Prescaler_1 = ((uint32_t)0x00000000), /*!< WWDG counter clock = (PCLK1/4096)/1 */
    WWDG_Prescaler_2 = ((uint32_t)0x00000080), /*!< WWDG counter clock = (PCLK1/4096)/2 */
    WWDG_Prescaler_4 = ((uint32_t)0x00000100), /*!< WWDG counter clock = (PCLK1/4096)/4 */
    WWDG_Prescaler_8 = ((uint32_t)0x00000180)  /*!< WWDG counter clock = (PCLK1/4096)/8 */
} WWDG_Prescaler;
