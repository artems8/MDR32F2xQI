...
/**
  * @brief RST_CLK PER1_C2 divisor selection constants
  */
typedef enum
{
    RST_CLK_PER1_C2_TIM0  = ((uint32_t)0x00),
    RST_CLK_PER1_C2_TIM1  = ((uint32_t)0x01),
    RST_CLK_PER1_C2_UART0 = ((uint32_t)0x02),
    RST_CLK_PER1_C2_UART1 = ((uint32_t)0x03),
    RST_CLK_PER1_C2_SSP1  = ((uint32_t)0x04)
} RST_CLK_PER1_C2_X_TypeDef;

#define IS_RST_CLK_PER1_C2_CLK_DIV(C2_DIV)      ((C2_DIV == RST_CLK_PER1_C2_TIM0) || \
                                                 (C2_DIV == RST_CLK_PER1_C2_TIM1)|| \
                                                 (C2_DIV == RST_CLK_PER1_C2_UART0) || \
                                                 (C2_DIV == RST_CLK_PER1_C2_UART1) || \
                                                 (C2_DIV == RST_CLK_PER1_C2_SSP1))
