 ...
 * @param  CLK_SRC -   @ref RST_CLK_PER1_C2_TypeDef - specifies the PER1_C2 clock source.
 * @param  PER1_C2_X - @ref RST_CLK_PER1_C2_X_TypeDef - divisor selection constants.
 * @retval None
 */
void RST_CLK_PCLKPer1_C2_CLKSelection (RST_CLK_PER1_C2_X_TypeDef C2_DIV,RST_CLK_PER1_C2_TypeDef CLK_SRC)
{
        /* Check the parameters */
    assert_param(IS_RST_CLK_PER1_C2_CLK_SRC(CLK_SRC));
    assert_param(IS_RST_CLK_PER1_C2_CLK_DIV(C2_DIV));
        switch (C2_DIV)
    {
        case RST_CLK_PER1_C2_TIM0: 
            MDR_RST_CLK->PER1_CLOCK = (MDR_RST_CLK->PER1_CLOCK & (~RST_CLK_PER1_CLOCK_TIM0_C2_SEL_Msk)) | (uint32_t)CLK_SRC;
            ;break;
        case RST_CLK_PER1_C2_TIM1:
            MDR_RST_CLK->PER1_CLOCK = (MDR_RST_CLK->PER1_CLOCK & (~RST_CLK_PER1_CLOCK_TIM1_C2_SEL_Msk)) | (uint32_t)CLK_SRC;
            ;break;
        case RST_CLK_PER1_C2_UART0: 
             MDR_RST_CLK->PER1_CLOCK = (MDR_RST_CLK->PER1_CLOCK & (~RST_CLK_PER1_CLOCK_UART0_C2_SEL_Msk)) | (uint32_t)CLK_SRC;
            ;break;
        case RST_CLK_PER1_C2_UART1: 
             MDR_RST_CLK->PER1_CLOCK = (MDR_RST_CLK->PER1_CLOCK & (~RST_CLK_PER1_CLOCK_UART1_C2_SEL_Msk)) | (uint32_t)CLK_SRC;
            ;break;
        case RST_CLK_PER1_C2_SSP1:
             MDR_RST_CLK->PER1_CLOCK = (MDR_RST_CLK->PER1_CLOCK & (~RST_CLK_PER1_CLOCK_SSP_C2_SEL_Msk)) | (uint32_t)CLK_SRC;
            ;break;
    }
}
...
*
* END OF FILE MDR32F2xQI_rst_clk_rst_clk.c */
